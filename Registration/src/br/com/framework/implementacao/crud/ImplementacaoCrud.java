...
public class ImplementacaoCrud<T> implements InterfaceCrud<T> {
	...
	private SimpleJdbcTemplate getSimpleJdbcClassImpl() {
	...
	public List<T> findListByQueryDinamica(String query, int iniciaNovoRegistro, int maximoResultado) throws Exception {
		validasessionFactory();
		List<T> lista = new ArrayList<T>();
		lista = sessionFactory.getCurrentSession().createQuery(query).setFirstResult(iniciaNovoRegistro).setMaxResults(maximoResultado).list();
		return lista;
	}
